...
import com.fvanaldewereld.rpgcompanion.data.game.di.GAME_DATA_MODULE
...
import com.fvanaldewereld.rpgcompanion.lib.domain.game.di.GAME_DOMAIN_LIB_MODULE
...
import com.fvanaldewereld.rpgcompanion.ui.game.detail.di.GAME_UI_DETAIL_MODULE
import com.fvanaldewereld.rpgcompanion.ui.game.list.di.GAME_UI_LIST_MODULE
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startKoin {
            ...
            // Game modules
            modules(GAME_DATA_MODULE)
            modules(GAME_DOMAIN_LIB_MODULE)
            modules(GAME_UI_DETAIL_MODULE)
            modules(GAME_UI_LIST_MODULE)
            // Scenario modules
